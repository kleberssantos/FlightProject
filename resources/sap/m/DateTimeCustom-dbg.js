			...
			var that = this,
				...
				oConfig = $.extend({}, oSettings, {
					...
					onShow : function($dialog) {
						...
						// has been closed
						if (oDevice.browser.internet_explorer) {
